...
Problem: My mother - who has zero knowledge of handling smartphones or tablet computer - wants a camera surveillance monitor with low to zero maintenance. It should work like a simple monitor, but it should not be vendor - locked. I as a developer want to configure it to show the camera video stream, independenty from the camera's vendor. And it should get its video stream from local WLAN. 
